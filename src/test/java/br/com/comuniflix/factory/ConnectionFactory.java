...
public class ConnectionFactory {
    ...
    private static final String USERNAME= "marcleo";

    private static final String PASSWORD = "123";

    private static final String DATABASE_URL = "jdbc:sqlserver://localhost:1433;DESKTOP-HE81TLJ\\SQLEXPRESS=BANCO_NETFLIX";
